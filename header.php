            ...
            <div class="logo">
                <div class="header-logo">
                    ...
                    <a href="<?php $this->options->adminUrl('login.php'); ?>">
                     <span class="b"><?php echo $GLOBALS['NAME'][0]; ?></span></a>
                     <span class="b"><?php echo $GLOBALS['NAME'][1]; ?></span>
                     <a href="<?php $this->options->siteUrl(); ?>">
                        <span class="w"><?php echo $GLOBALS['NAME'][2]; ?></span>
                    </a>
                    <span class="b"><?php echo $GLOBALS['NAME'][3]; ?></span>
                    <span class="b"><?php echo $GLOBALS['NAME'][4]; ?></span>
                    <!-- 标题结束 -->
