                ...
                <div class="header-logo">
                    ...
                    <?php if($this->options->NAME):?>
                        <a href="<?php $this->options->adminUrl('login.php'); ?>">
                           <span class="b"><?php echo $this->options->NAME[0]; ?></span></a>
                           <span class="b"><?php echo $this->options->NAME[1]; ?></span>
                           <a href="<?php $this->options->siteUrl(); ?>">
                            <span class="w"><?php echo $this->options->NAME[2]; ?></span>
                        </a>
                        <span class="b"><?php echo $this->options->NAME[3]; ?></span>
                        <span class="b"><?php echo $this->options->NAME[4]; ?></span>
                        <?php else :?>
                            <a href="<?php $this->options->adminUrl('login.php'); ?>">
